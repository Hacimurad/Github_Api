class UI{
    constructor(){
        ...
        this.latUsers=document.getElementById("last-users");
     ...
     addSearcUI(username){
      ...
      if(users.indexOf(username)=== -1){
        ...
        this.latUsers.appendChild(liDiv);
     ...
     clearAllUI(){
         ...
         while(this.latUsers.firstElementChild !==null){
             this.latUsers.removeChild(this.latUsers.firstElementChild);
         }
     }
